...
public class ColorProgressBar extends LinearLayout {
	...
	private void initLayout(Context context){
		...
		_leftLP = new LayoutParams(0, android.view.ViewGroup.LayoutParams.MATCH_PARENT, 1);
		...
		_rightLP = new LayoutParams(0, android.view.ViewGroup.LayoutParams.MATCH_PARENT, 99);
